...
import ActiveOptionGainers from "./ActiveOptionGainers";
import ActiveOptionLosers from "./ActiveOptionLosers";

class ActiveOptionStocks extends Component {
    state = {
        activePage:1,
    }
    ...
    _renderComponent = () => {
      if(this.state.activePage === 1)
        return <ActiveOptionGainers/> 
      else 
        return <ActiveOptionLosers/> 
    }
...
export default ActiveOptionStocks;
