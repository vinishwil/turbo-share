...
var url = 'https://www.nseindia.com/live_market/dynaContent/live_analysis/losers/jrNiftyLosers1.json';

class ActiveNextNiftyLosers extends Component {
    constructor() {
        super();
        this.state = {
            activeStocks: [],
...
export default ActiveNextNiftyLosers;
