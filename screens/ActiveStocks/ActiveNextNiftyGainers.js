...
var url = 'https://www.nseindia.com/live_market/dynaContent/live_analysis/gainers/jrNiftyGainers1.json';

class ActiveNextNiftyGainers extends Component {
    constructor() {
        super();
        this.state = {
            activeStocks: [],
...
export default ActiveNextNiftyGainers;
